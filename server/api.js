...
const fpVideos = [
  {
    ...
    color: 'blue',
    tip: deline`
      Redux-First Router does not require you to embed actual links into the page
  ...
  },
  {
    ...
    color: 'blue',
    tip: deline`
      Redux reducers programmatically allow you to produce any state you need.
  ...
  },
  {
    ...
    color: 'blue',
    tip: deline`
      In your actions.meta.location key passed to your reducers you have all sorts
...
const reactReduxVideos = [
  {
    ...
    color: 'red',
    tip: deline`
      Redux-First Router tries in all cases to mirror the Redux API. There is no need
  ...
  },
  {
    ...
    color: 'red',
    tip: deline`
      Redux-First Router requires your payload to be objects, as its keys are directionally extracted
  ...
  },
  {
    ...
    color: 'red',
    tip: deline`
      The <Link /> component embeds paths in hrefs for SEO, but you don't need to use it
...
const dbGraphQLVideos = [
  {
    ...
    color: 'orange',
    tip: deline`
      The 'thunk' feature is optional, but very useful. Using our 'thunk' feature allows you
  ...
  },
  {
    ...
    color: 'orange',
    tip: deline`
      Structure your reducers so that less actions are used to trigger the same state.
  ...
  },
  {
    ...
    color: 'orange',
    tip: deline`
      Using a hash of slugs within one of your reducers is the recommended approach to
...
export const findVideos = async category => {
  ...
  switch (category) {
    ...
    case 'react-redux': return reactReduxVideos;
    case 'db-graphql': return dbGraphQLVideos;
    default: return [];
  }
};
